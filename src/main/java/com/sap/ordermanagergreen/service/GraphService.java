    ...
    public List<DeliverCancelOrdersDTO> getDeliverCancelOrders() {
        ...
        Aggregation aggregation = newAggregation(
                ...
                group("month")
                        ...
                        //.sum(ConditionalOperators.when(ComparisonOperators.valueOf("orderStatus").equalToValue(OrderStatus.PAYMENT_CANCELED || OrderStatus.process_CANCELED)).then(1).otherwise(0)).as("delivered"),
                project()
                        .and("_id").as("month")
